## TODO: 
Було б круто додати тести для ExplorerCore, оскільки його вже можна перевіряти без запуску ROS. 
Найкорисніші сценарії тут: 
- повернення з тупика, 
- продовження маршруту після контакту 
- та розходження фактичної позиції з очікуваною. 
