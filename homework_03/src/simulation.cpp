...
auto Simulation::getTgtPositionAt(size_t tgt_tag, double time_s) -> pointmath::Point
{
  ...
  Point pos = (track[ind_next] - track[ind]) * (ind_frac - ind_double);
  pos += track[ind];
  return pos;
}
