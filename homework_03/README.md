...
## **Що змінюється:**
   ...
   3. Динамічні масиви (new[]/delete[]) замість хардкоджених розмірів
   4. Формат JSON для всіх файлів введення/виведення (бібліотека nlohmann/json)
   5. #define макроси для виведення в консоль та дебаг-інформації - Done


## Additionally
   1. ballistics libruary, which was not part of HW2(taken as ready from HW6) reworked to optimize calculations
